[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/kVDWnVww)
[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=22448247)


This repo contains Chapters 2, 3 and 4 of the book described below. 
This repo is for the second week assignment in Phy 225.
Students should:
 - Fork this repo (should happen when you accept the assignment link in Github Classroom)
 - Read the content.ipynb and summary.ipynb notebooks in each chapter to review functions, conditionals (`if`, etc.), and iteration/loops (`for`, `while`). (You can add private notes in your repo without affecting what others see!)
   -  02_functions/00_content.ipynb
   -  02_functions/02_content.ipynb
   -  02_functions/03_summary.ipynb
   -  03_conditionals/00_content.ipynb
   -  03_conditionals/05_summary.ipynb
   -  04_iteration/00_content.ipynb
   -  04_iteration/02_content.ipynb
   -  04_iteration/03_content.ipynb
   -  04_iteration/05_summary.ipynb
-  Complete the exercise notebooks in each chapter. **Commit after completing each notebook.**
   -   02_functions/01_exercises_functions.ipynb
   -   03_conditionals/01_exercises_conditionals_modern_physics.ipynb
   -   04_iteration/04_exercises_dice.ipynb
   -   04_iteration/05_exercises_iteration_modern_physics.ipynb
-   Review the 'review' notebooks in each chapter to study
-   Make a final commit (add FINAL to the commit comments) to indicate you have finished the assignment.
  
To keep track of which assignments you have completed, you can edit this README.md file to include a checkmark ( :check: ) in front of each exercise you have completed.
